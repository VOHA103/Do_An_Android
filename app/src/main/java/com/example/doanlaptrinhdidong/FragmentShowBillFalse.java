...
public class FragmentShowBillFalse extends Fragment {
    Context context;
    int i;
    ...
    public FragmentShowBillFalse(Context context, int i) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerViewBillFalse);
    ...
    public void loadBillFalse() {
        String url = Server.urlBillFalse;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_show_bill_false, container, false);
    }
}