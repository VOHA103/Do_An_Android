...
public class RoomDetailFalse extends AppCompatActivity {
    TextView txtNameRoom,txtAddress,txtTypeRoom;
    ImageView imgRoom;
    Button btnCancel,btnTraPhong,btnThuPhong;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_room_detail_false);
        maping();
    ...
    public void maping(){
        ...
        btnThuPhong=findViewById(R.id.btnThuePhong);
    }
